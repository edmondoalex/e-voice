    ...
    async def interpret(self, question: str, entities: tuple[EntitySnapshot, ...]) -> str | None:
        ...
        payload = {
            ...
            "instructions": (
                ...
                "esportata. Se la domanda chiede tutti o entrambi i fotovoltaici, conserva "
                "entrambi i siti e genera esattamente 'quanto produce il fotovoltaico SAS e "
                "privato'. Se manca il sito, non sceglierlo arbitrariamente: genera la query "
