...
class Installation(TimestampMixin, Base):
    ...
    connector_protocol_version: Mapped[int | None] = mapped_column()
    connector_capabilities_json: Mapped[dict[str, bool] | None] = mapped_column(JSON)
    connector_compatibility_status: Mapped[str | None] = mapped_column(String(30))
    connector_compatibility_reason: Mapped[str | None] = mapped_column(String(100))
